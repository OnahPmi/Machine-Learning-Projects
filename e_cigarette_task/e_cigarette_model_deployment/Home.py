...
st.write(
  ...
  **This server implements the :rainbow[Random Forest Model] for predicting the potential of E-cigarette use among veterans and Non-Veterans in the US.  
    The data for the model training was obtained from the publicly abailabel _US NHIS_.**
  """
)
...
try:
  ...
  st.error("### An error occured while trying to load the Random Forest Model and the Data File. Ensure that all dependencies such scikit-learn version >= 1.3.0 is installed in your streamlit environment")
